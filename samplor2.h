...
void samplor_loopxfade(t_samplorpd *x, t_floatarg loop_xfade);
...
void samplor_win(t_samplorpd *x, t_floatarg win);
...
void samplor_stop2(t_samplorpd *x, t_floatarg time);
...
float samplor_get_value(t_atom *a);
